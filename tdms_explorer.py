...
A Python module for working with TDMS (Technical Data Management Streaming) files.
This module provides functionality to:
- List contents of TDMS files
- Display images and animations from TDMS files
- Write individual or complete series of images
- Extract metadata and properties

Requires: nptdms, numpy, matplotlib, PIL
"""
...
if __name__ == "__main__":
    # Example usage
    print("TDMS Explorer Module")
    print("Usage examples:")
    print()
    print("# List all TDMS files in current directory")
    print("files = list_tdms_files()")
    print()
    print("# Create explorer for a TDMS file")
    print("explorer = TDMSFileExplorer('example.tdms')")
    print()
    print("# List contents of TDMS file")
    print("explorer.print_contents()")
    print()
    print("# Display a single image")
    print("explorer.display_image(0)")
    print()
    print("# Display animation")
    print("explorer.display_animation(fps=15)")
    print()
    print("# Write all images to directory")
    print("explorer.write_images('output_images')")
    print()
    print("# Write single image")
    print("explorer.write_image(0, 'single_image.png')")